...
export const Posts: CollectionConfig = {
  ...
  fields: [
    ...
    /* FAQ (для SEO JSON-LD FAQPage) */
    {
      name: "faq",
      type: "array",
      label: "FAQ",
      admin: {
        description: "Частые вопросы — генерируют JSON-LD FAQPage",
      },
      fields: [
        { name: "вопрос", type: "text", required: true, label: "Вопрос" },
        { name: "ответ", type: "textarea", required: true, label: "Ответ" },
      ],
    },
    /* Просмотры */
    {
