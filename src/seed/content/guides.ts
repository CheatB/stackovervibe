...
export const enrichedGuides: EnrichedGuideContent[] = [
     ...
     ===================================================== */
  {
    ...
    content: root([
      ...
      paragraph(
        "Вайбкодинг — это когда ты говоришь компьютеру что сделать, а он пишет код за тебя. Как диктовать письмо секретарю. Ты объясняешь идею — AI делает техническую работу.",
      ),
      paragraph(
        "Не нужно учить языки программирования. Не нужно знать как работает сервер. Просто описывай что хочешь получить — и получай рабочий результат. Это проще чем кажется.",
      ),
      hr(),
