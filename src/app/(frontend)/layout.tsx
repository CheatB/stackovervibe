  ...
  return (
    <html lang="ru" className="dark">
      ...
      <body className="min-h-screen flex flex-col">
        {/* Глобальные эффекты: искры при клике (фиксированный оверлей) */}
        <LayoutEffects />
        {/* CRT-скенлайны */}
        ...
        <header className="relative border-b border-[var(--color-border)] px-4 sm:px-6 py-3">
          <nav className="max-w-6xl mx-auto flex items-center justify-between">
            ...
            >
              <span className="text-[var(--color-text-muted)]">visitor@</span>
              stackovervibe
        ...
        {/* Footer — ASCII + ретро + GridMotion фон */}
        <footer className="relative border-t border-[var(--color-border)] px-4 sm:px-6 py-8 text-center overflow-hidden">
          <FooterGrid />
